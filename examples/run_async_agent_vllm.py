...
from lumina.agents.stream import AsyncAgentForlumina, AsyncMathCoder
from lumina.llms import lumina2_META
from lumina.llms.vllm_wrapper import AsyncVllmModel
...
coder = AsyncMathCoder(
    llm=model,
    interpreter=dict(
        type='lumina.actions.AsyncIPythonInterpreter', max_kernels=200),
