...
from lumina.actions import ActionExecutor, AsyncActionExecutor, BaseAction
from lumina.agents.agent import Agent, AsyncAgent
from lumina.agents.aggregator import DefaultAggregator
from lumina.hooks import ActionPreprocessor
from lumina.llms import BaseLLM
from lumina.memory import Memory
from lumina.prompts.parsers.json_parser import JSONParser
from lumina.prompts.prompt_template import PromptTemplate
...
if __name__ == '__main__':
    ...
    from lumina.llms import GPTAPI, AsyncGPTAPI
    ...
    agent = ReAct(
        ...
        output_format=output_format,
        aggregator=dict(type='lumina.agents.aggregator.DefaultAggregator'),
        actions=[dict(type='lumina.actions.PythonInterpreter')],
    )
    ...
    async_agent = AsyncReAct(
        ...
        output_format=output_format,
        aggregator=dict(type='lumina.agents.aggregator.DefaultAggregator'),
        actions=[dict(type='lumina.actions.AsyncPythonInterpreter')],
    )
